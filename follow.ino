...
// V 4.1 (Modified to increase speed by 25%)
// Last Modified 9/06/2023 by MingWei Yeoh and Karcher Morris
// Modified on 3/13/2025 to increase speed by 25%
/* ************************************************************************************************* */
...
#define SPEED_MULTIPLIER    1.25 // New constant to increase overall motor speeds by 25%
...
void loop() {
  digitalWrite(led_Pins[0], LOW);   // turn the LED on (HIGH is the voltage level)
...
void RunMotors() {
  // Multiply overall motor speed by SPEED_MULTIPLIER to increase speed by 25%
  M1SpeedtoMotor = min((int)((NOMINALSPEED + SpRead + M1P) * SPEED_MULTIPLIER), 255); // limits speed to 255
  M2SpeedtoMotor = min((int)((NOMINALSPEED + SpRead + M2P) * SPEED_MULTIPLIER), 255); // remember M1Sp & M2Sp is defined at beginning of code
