...
int led_Pins[] = {13,41,43,45,47,49,51};  // LEDs to indicate what part of calibration you're on and to illuminate the photoresistors
...
void setup() {
  ...
  FastLED.addLeds<WS2811, 53, GRB>(leds, 9).setCorrection( TypicalLEDStrip );
  for(int i = 0; i < 9; i++){
      leds[i] = CRGB:: White;
    }
    FastLED.show();
